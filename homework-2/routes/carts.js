                                        ...
                                        if(!err){
                                            ...
                                            _helpers.getCartItemsById(data, itemId, (err, res) => {
                                                if (!err) {
                                                    ...
                                                    callback(200, {"Message": "Item already exists in cart"});
                                                } else {
            ...
            if (tokenIsValid) {
                ...
                _data.read('carts', phone, (err, data) => {
                    if (!err && data) {
                        ...
                        callback(404, {'Error': 'No items in your cart'});
                    }
                });
            } else {
                callback(403, {'Error': 'Authentication token is not provided or is invalid'});
                ...
                _data.read('pizzas', 'pizza', (err, data) => {
                    if (!err && data) {
                        ...
                        if( JSON.stringify(item).length > 2 ){
                                        ...
                                        if (!err) {
                                            ...
                                            _data.update('carts', phone, data, (err) => {
                                                if(!err){
                                                    ...
                                                    callback(405, {"Error": "Could not update item in the cart"});
                                                }
                                            });
                                        } else {
                                            callback(400, {'Error': 'Cannot update item. Item not found'});
                                        }
                                    });
                                } else {
                            ...
                            callback(400, {'Error': 'The item you specified doesn\'t exist'});
                        }
                    } else {
                        callback(400, {'Error': 'Could not retrieve pizza menu'});
                    }
                });
            } else {
                callback(403, {'Error': 'Authentication token is not provided or is invalid'});
